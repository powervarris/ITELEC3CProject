            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-12">
                    ...
                    <div class="card p-3 mb-4 shadow-sm rounded">
                        <form action="{{ route('forum.general.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row g-2 align-items-center">
                                ...
                                <div class="col">
                                    <input type="text" name="content" class="form-control" placeholder="What's on your mind about Pokémon?" required maxlength="255" />
                                </div>
                                <div class="col-auto">
...
<script>
    function populateEditForm(post) {
        document.getElementById('editPostForm').action = `/forum/general/${post.id}`;
