...
@section('content')
    <section class="container-fluid my-4">
        ...
        <div class="text-center mb-5 w-100">
            <h1 class="forum-header">General Forum</h1>
        </div>
                ...
                <div class="col-lg-8 col-md-12">
                    ...
                    <div class="card p-3 mb-4 shadow-sm rounded">
                        <div class="row g-2 align-items-center">
                            <div class="col-auto">
                                <img src="{{ asset('images/pikachu.jpg') }}" class="rounded-circle" alt="User Avatar" style="width: 50px; height: 50px;">
                            </div>
                            <div class="col">
                                <input type="text" class="form-control" placeholder="What's on your mind about Pokémon?" />
                            </div>
                            <div class="col-auto">
                    ...
                    <!-- Tabs Section -->
                    <ul class="nav nav-pills tab-links mb-4 justify-content-start">
                        <li class="nav-item">
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        <h6 class="mb-0">Legendary Trainers</h6>
                                        <small class="text-muted">Posted by Ash Ketchum • 5 min ago</small>
                                    </div>
                                </div>
                                <p class="mt-3">What's your favorite Legendary Pokémon and why?</p>
                                <img src="{{ asset('images/forum.jpg') }}" class="img-fluid rounded" alt="Post Image">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled">
                                    <li>
                                        <span class="d-block">#PikachuLovers</span>
                                        <small class="text-muted">15k Threads</small>
                                    </li>
                                    <li class="mt-2">
                                        <span class="d-block">#TeamRocketFails</span>
                                        <small class="text-muted">12k Threads</small>
                                    </li>
                                    <li class="mt-2">
                                        <span class="d-block">#KantoRegion</span>
                                        <small class="text-muted">20k Threads</small>
                                    </li>
                                    <li class="mt-2">
                                        <span class="d-block">#LegendaryCatch</span>
                                        <small class="text-muted">18k Threads</small>
                                    </li>
                                    <li class="mt-2">
                                        <span class="d-block">#PokémonTrivia</span>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    ...
                                    <span class="badge bg-light text-dark border">Shiny Hunting</span>
                                    <span class="badge bg-light text-dark border">Battle Strategies</span>
                                    <span class="badge bg-light text-dark border">Card Collecting</span>
                                    <span class="badge bg-light text-dark border">Pokémon GO Tips</span>
                                    <span class="badge bg-light text-dark border">Pokédex Completion</span>
                                    <span class="badge bg-light text-dark border">Trading Tips</span>
                                </div>
